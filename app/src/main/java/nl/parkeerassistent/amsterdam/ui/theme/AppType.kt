...
object AppType {
    val license = TextStyle(fontSize = 24.sp, fontWeight = FontWeight.SemiBold, letterSpacing = 1.5.sp)
...
object AppShape {
    val roundedSmall = RoundedCornerShape(Dimens.radiusSmall)
    val roundedNormal = RoundedCornerShape(Dimens.radiusNormal)
}